...
func NotifikasiEmailDiubahTemplate(namaUser string, emailBaru string, alamatIP string, waktu string) string {
	return fmt.Sprintf(`
								...
								<table width="100%%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" style="color: #64748b; font-size: 13px; line-height: 1.7; padding-bottom: 24px;">
											Kami menginformasikan bahwa alamat email akun SIM Magang Diskominfo Anda baru saja diubah.
										</td>
									</tr>
											...
											<table width="100%%" cellpadding="0" cellspacing="0" bgcolor="#f0f9ff" style="background-color: #f0f9ff; border: 1.5px dashed #7dd3fc; border-radius: 16px;">
												<tr>
													<td align="center" style="padding: 20px;">
														<p style="color: #0369a1; font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; margin: 0 0 8px;">Email Baru Anda</p>
														<span style="font-size: 17px; font-weight: 800; color: #004F9F;">%s</span>
													</td>
												</tr>
											</table>
										</td>
											...
											<table width="100%%" cellpadding="0" cellspacing="0" bgcolor="#f8fafc" style="background-color: #f8fafc; border-radius: 12px;">
												<tr>
													<td style="padding: 14px 16px;">
														<p style="color: #94a3b8; font-size: 9.5px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; margin: 0 0 8px;">Informasi Permintaan</p>
														<table width="100%%" cellpadding="0" cellspacing="0">
															<tr>
	...
	`, namaUser, emailBaru, waktu, alamatIP, time.Now().Year())
}