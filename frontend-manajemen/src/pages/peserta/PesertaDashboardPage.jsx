      ...
      <div className="space-y-6 animate-[fadeslide_0.35s_ease-out]">
        <div>
          <h2 className="text-2xl font-black tracking-tight text-slate-900">
            {isMagangSelesai() ? "Selamat, Anda Telah Menyelesaikan Magang" : "Selamat Datang, Peserta Magang"}
          </h2>
          <p className="mt-1 text-sm font-medium text-slate-500">
            {isMagangSelesai()
              ? "Akun Anda tetap aktif untuk mengunduh sertifikat, melihat raport, dan menelusuri riwayat presensi."
              : "Fitur logbook dan absensi magang akan tersedia di sini."}
          </p>
        </div>
