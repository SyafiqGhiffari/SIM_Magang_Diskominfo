...
const BidangActionsDropdown = ({ onEdit, onDelete }) => {
          ...
          >
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-[#0B1442]">Edit Bidang</p>
                <p className="text-[10px] text-slate-400 whitespace-nowrap">Ubah detail dan kuota bidang</p>
              </div>
            </button>
            ...
            <button
              ...
              className="group/item flex w-full items-center gap-3 px-4 py-3 text-left bg-red-50/40 hover:bg-red-50/70 transition-colors duration-200 cursor-pointer"
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-red-700">Hapus Bidang</p>
...
export default BidangActionsDropdown;