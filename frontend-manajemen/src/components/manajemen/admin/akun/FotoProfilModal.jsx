const FotoProfilModal = ({
  ...
  return (
    ...
    >
      <div
        className={`relative max-w-md w-full rounded-3xl border shadow-2xl overflow-hidden animate-[modalPop_0.25s_cubic-bezier(0.34,1.56,0.64,1)] ${dk ? "bg-[#161b22] border-white/10" : "bg-white border-slate-200"}`}
      ...
      >
        ...
        <div className="relative px-6 py-5 bg-gradient-to-r from-[#0B1442] via-[#141F5C] to-[#1E3A8A] overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            ...
            <button
              ...
              className="group h-8 w-8 rounded-lg flex items-center justify-center text-white/70 hover:text-white hover:bg-white/15 transition-all cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 transition-transform duration-300 group-hover:rotate-90">
        ...
        <div className={`flex gap-3 px-6 pb-6 pt-4 border-t ${divider} transition-opacity duration-300 ${fotoModalLoading ? "opacity-30 pointer-events-none" : ""}`}>
          <button
            ...
            className={`group flex-1 inline-flex items-center justify-center gap-2 rounded-lg border px-4 py-2.5 text-xs font-bold hover:-translate-y-0.5 active:scale-95 active:translate-y-0 transition-all duration-200 cursor-pointer ${dk ? "border-white/15 text-slate-200 hover:bg-white/10" : "border-slate-300 text-[#0B1442] hover:bg-slate-50"}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110">
          ...
          <button
            ...
            className="group flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#0B1442] to-[#1E3A8A] px-4 py-2.5 text-xs font-bold text-white shadow-lg hover:from-[#101F5C] hover:to-[#004F9F] hover:shadow-xl hover:-translate-y-0.5 active:scale-95 active:translate-y-0 transition-all duration-200 cursor-pointer"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:scale-110">
