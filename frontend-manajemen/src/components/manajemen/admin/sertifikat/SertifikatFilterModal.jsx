...
import { Filter as FilterIcon, X, ListFilter, RotateCcw, Check } from "lucide-react";

const statusOptions = [
  { key: "terbit", label: "Sudah Terbit" },
  { key: "magang", label: "Sedang Magang" },
  { key: "perlu", label: "Perlu Dibuat" },
];
...
const SertifikatFilterModal = ({ statusList, toggleStatus, onApply, onReset, onClose }) => {
  useEffect(() => {
      ...
      >
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[#0B1442] via-[#101F5C] to-[#1E3A8A] px-6 py-6 shrink-0">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-black text-white">Filter Sertifikat</h3>
              <p className="text-[11px] text-white/60 mt-0.5">Saring peserta berdasarkan status sertifikatnya</p>
            </div>
          </div>
...
export default SertifikatFilterModal;