...
const sortOptions = [
  ...
  { key: "periode_baru", label: "Periode Terbaru" },
  { key: "periode_lama", label: "Periode Terlama" },
  { key: "status", label: "Status Sertifikat" },
];

const SertifikatSortDropdown = ({ sortBy, setSortBy }) => {
  ...
  useEffect(() => {
    ...
    // Ikuti tombol saat scroll, jangan tutup sendiri
...
export default SertifikatSortDropdown;