...
const FaqSortDropdown = ({ sortBy, setSortBy }) => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-11 z-20 w-56 rounded-xl border border-slate-200 bg-white shadow-xl overflow-hidden animate-[fadeslide_0.15s_ease-out]">
          {sortOptions.map((opt) => (
            <button
              key={opt.key}
