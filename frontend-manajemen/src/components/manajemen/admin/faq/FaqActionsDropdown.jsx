...
const FaqActionsDropdown = ({ onEdit, onDelete }) => {
          ...
          >
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-[#0B1442]">Edit FAQ</p>
                <p className="text-[10px] text-slate-400 whitespace-nowrap">Ubah jawaban dan pengaturan</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-red-700">Hapus FAQ</p>
...
export default FaqActionsDropdown;