...
const TentangPage = () => {
  ...
  const misi = config.konten?.misi || [];
  const tujuan = config.konten?.tujuan || [];
  const keunggulan = config.konten?.keunggulan || [];
      ...
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid items-center gap-8 rounded-2xl border border-slate-200/80 bg-white p-8 shadow-sm md:grid-cols-12 md:p-10">
          <div className="relative overflow-hidden rounded-xl border border-slate-100 shadow-sm md:col-span-4">
            <img
              src={t.foto_kantor || "/images/kantor-diskominfo.jpg"}
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-8 shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold text-[#0B1442]">{t.misi_judul}</h3>
        ...
        <div className="mt-12 rounded-2xl border border-slate-200/80 bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-8 grid gap-6 text-left sm:grid-cols-3">
            {tujuan.map((item) => (
              <div
                key={item.id}
                className="rounded-xl border border-slate-100 bg-slate-50 p-6 transition-colors duration-300 hover:border-[#5B8DEF]/30"
              >
